pub const OPOLYS_WORDLIST: &[&str] = &[
    ...
    "betray", "better", "between", "beyond", "bicycle", "bidding", "bind", "biology", "bird", "birth",
...
pub fn display_word(index: usize) -> String {
    if index < OPOLYS_WORDLIST.len() {
        format!("{}-{}", OPOLYS_WORDLIST[index], index + 1)
    } else {
