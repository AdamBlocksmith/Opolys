...
//!
//! Mined-block fees are burned; refiner-block fees pay the selected refiner producer.
//! The monetary model follows a natural equilibrium with no hard cap — supply grows at the rate of real-world gold production.
